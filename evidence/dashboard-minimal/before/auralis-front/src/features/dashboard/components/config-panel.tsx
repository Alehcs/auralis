...
export function ConfigPanel() {
  ...
  const DEVICE    = IS_FROZEN_DEMO ? 'Archivo de resultados · sin motor activo' : 'ONNX Runtime · CPU (edge)';
  const BATCH     = IS_FROZEN_DEMO ? 'No se ejecutan lotes' : '32';
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-5">
        <SectionHeader icon={Bell} title={s.notifications} description={IS_FROZEN_DEMO ? "Desactivadas en la demo estática" : s.notificationsDesc} />
        <div className="space-y-2">
