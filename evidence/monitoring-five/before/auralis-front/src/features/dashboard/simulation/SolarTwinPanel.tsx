...
export function SolarTwinPanel() {
  ...
  return <section aria-label="Gemelo solar Unity/Needle" className="space-y-3">
    <div className="flex flex-wrap items-center justify-between gap-3">
      <div><h1 className="text-xl font-semibold text-white">Gemelo solar</h1>
        <p className="text-sm text-neutral-400">Cinco estados HMI · Coronium V3.1 precalculado · recreación ilustrativa.</p></div>
      <a className="rounded-lg border border-neutral-700 px-4 py-3 text-sm text-amber-200" href={direct.href} target="_blank" rel="noopener noreferrer">Abrir en móvil / AR ↗</a>
    </div>
    <details className="text-sm text-neutral-400">
      <summary className="cursor-pointer py-3 hover:text-neutral-200">AR en el móvil</summary>
      <p className="pb-3">iPhone: Safari → Needle Go. Se conserva la fecha del visor, independiente del dashboard.</p>
    </details>
