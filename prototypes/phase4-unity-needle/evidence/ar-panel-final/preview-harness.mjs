...
const arPreview=document.createElement('button');arPreview.textContent='Inspeccionar panel AR (sin sesión XR)';arPreview.onclick=()=>{const p=document.querySelector('.phase5-ar');p.style.display='block';p.style.visibility='visible';p.style.position='fixed';p.style.width='369px';p.style.zIndex='10000';};document.querySelector('.view-controls').append(arPreview);
