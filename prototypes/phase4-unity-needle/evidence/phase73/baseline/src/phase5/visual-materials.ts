  ...
  root.traverse(o=>{
    ...
    if(temporal&&o.name==='SubtleCorona'){
      for(const material of Array.isArray(o.material)?o.material:[o.material]){
        material.customProgramCacheKey=()=> 'auralis-corona-v72';
    ...
    for(const material of Array.isArray(o.material)?o.material:[o.material]) {
      ...
      material.customProgramCacheKey=()=>solar?(temporal?'auralis-solar-motion-v72':'auralis-solar-polish-v1'):'auralis-data-display-'+o.name;
      material.onBeforeCompile=(shader:Parameters<Material['onBeforeCompile']>[0])=>{
