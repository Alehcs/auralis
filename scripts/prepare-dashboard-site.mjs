...
if (!js.includes('/demo/responses.json') || !js.includes('auralis-phase4-needle-probe.alejandro-cornejog4.chatgpt.site')) throw Error('Build with --mode sites before packaging.');
