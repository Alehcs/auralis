...
def plot_all(out, data, history, best_epoch, bands, worst, metrics, latency):
    ...
    fig, axes = plt.subplots(1, 2, figsize=(12, 5), layout="constrained")
    axes[0].scatter(data.onnx_si, data.mc_si, c=y, cmap="viridis", s=20)
...
def main():
    ...
    source_paths = [Path(__file__), ROOT / "scripts/plot_final_scatter.py", ROOT / "scripts/plot_r2_diagnostic.py", ROOT / "scripts/evaluate_final.py", ROOT / "src/experiments/run_external_baselines.py"]
