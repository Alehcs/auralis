...
from models.active_model import (CHECKPOINT_PATH, ONNX_PATH, MODEL_NAME, MODEL_VERSION,
                                 METRICS_STATUS, COMPARISON_PATH, load_release)
...
async def get_results_comparison():
    """Serve V3.1 clean MC evaluation, consistent with the official stats."""
    import csv
    ...
    with open(csv_path, newline="", encoding="utf-8") as fh:
        ...
        for row in reader:
            points.append({
                ...
                "evaluation_protocol": "MC Dropout T=20; clean validation used for selection",
