"""
AURALIS - Solar Activity Prediction System
...
# ============================================================================
st.set_page_config(
    page_title="AURALIS - Solar Prediction",
    page_icon="☉",
    layout="wide",
...
def main():
    ...
    if image_array is not None:
        ...
        with st.container():
            ...
            st.markdown("""
            **AURALIS** is an advanced solar activity prediction system using deep learning 
