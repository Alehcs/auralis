"""Interpretabilidad de SolarNetV3 PRO mediante Grad-CAM nativo en PyTorch.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Uso (desde la raíz HeliosPipeline/):
...
from train_model import SolarNetV3  # noqa: E402
...
# ---------------------------------------------------------------------------
# Rutas (relativas al directorio de trabajo HeliosPipeline/)
# ---------------------------------------------------------------------------
WEIGHTS_PATH  = Path("models/helios_v3_pro.pth")
DATA_DIR      = Path("data/processed")
OUTPUT_FIGURE = Path("reports/figures/gradcam_sample.png")

# Atributo de SolarNetV3 que corresponde a la última etapa convolucional.
...
class GradCAMHookManager:
    ...
    Args:
        model:      Instancia de SolarNetV3 inicializada y cargada.
...
def compute_gradcam(
    ...
    Args:
        model:        SolarNetV3 en modo evaluación (model.eval() activo).
    ...
    if activations is None or gradients is None:
        raise RuntimeError(
            ...
            "atributo válido de SolarNetV3 con salida tensorial."
        )
...
def main() -> None:
    """Pipeline completo de explicabilidad Grad-CAM para SolarNetV3 PRO.
    ...
    # ── 2. Cargar modelo ──────────────────────────────────────────────────────
    model = SolarNetV3(in_channels=2, dropout_rate=DROPOUT_RATE)
    ...
    logger.info(
        "SolarNetV3 PRO cargado — %d parámetros  |  modo eval activo  |  device: %s",
        total_params,
        device,
    )
