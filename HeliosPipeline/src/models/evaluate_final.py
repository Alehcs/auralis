"""Evaluación definitiva de SolarNet V3 PRO para tesis.

Carga el checkpoint final (models/helios_v3_pro.pth), ejecuta inferencia sobre
...
NOTA SOBRE UNIDADES:
    El target que SolarNet aprende es el índice proxy de manchas solares
...
Uso (desde la raíz del repo HeliosPipeline/):
...
from train_model import SolarDataset, SolarNetV3  # noqa: E402
...
# ---------------------------------------------------------------------------
# Configuración de rutas  (relativas al directorio HeliosPipeline/)
# ---------------------------------------------------------------------------
...
def print_thesis_report(metrics: dict, n_samples: int, mean: float, std: float) -> None:
    ...
    sep = "=" * 62
    print(f"\n{sep}")
    print("  SolarNet V3 PRO — Reporte de Evaluación Definitiva")
    print(sep)
