"""Scatter-plot evaluation of SolarNetV3 PRO on the validation set.
...
Usage (from repo root):
    python HeliosPipeline/src/models/evaluate_model.py
"""
...
from train_model import SolarDataset, SolarNetV3
...
def plot_scatter(targets: np.ndarray, preds: np.ndarray, output_path: Path) -> None:
    ...
    ax.set_title("SolarNetV3 PRO — Predicted vs. Real\n(Validation Set)", fontsize=14)
