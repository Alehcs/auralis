"""
HELIOS - Solar Activity Prediction System
Deep Learning-based solar magnetogram analysis and activity forecasting
"""
...
# ============================================================================
st.set_page_config(
    page_title="HELIOS - Solar Prediction",
    page_icon="☉",
    layout="wide",
...
MODEL_PATH = PROJECT_ROOT / "models" / "helios_v2_pro.pth"
...
class SolarNet(nn.Module):
    """Convolutional neural network for solar activity prediction."""
...
@st.cache_resource
def load_model():
    """Load trained SolarNet V2 PRO model."""
...
def load_available_images():
    """Load list of processed magnetogram files."""
...
def predict_activity(model, device, image_array):
    """Execute model inference on magnetogram."""
...
def create_gauge_chart(value):
    """Generate activity index gauge visualization."""
...
def get_risk_level(activity_index):
    """Calculate risk level from activity index."""
...
def main():
    ...
    <div style='text-align: center; padding: 1rem 0 0.5rem 0;'>
        ...
        <p style='margin: 0.3rem 0 0 0; font-size: 0.95rem; color: #A0A0A0; font-weight: 400;'>
            Real-Time Monitoring | Model: <span style='color: #1E88E5;'>SolarNet V2 PRO</span> | Val MAE: <span style='color: #2ECC71;'>0.07%</span>
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style='text-align: center; font-size: 0.85rem; color: #808080;'>
        <p>Deep Learning-based solar<br>activity prediction system</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if image_array is not None:
        ...
        with st.container():
            ...
            with context_col1:
                ...
                <div class='info-card'>
                    ...
                    <p style='color: #C0C0C0; font-size: 0.9rem; line-height: 1.6;'>
                        Solar storms can damage satellite electronics. Early prediction enables 
                        preventive protocols and protects critical space assets.
                    </p>
                </div>
                """, unsafe_allow_html=True)
            ...
            with context_col2:
                ...
                <div class='info-card'>
                    ...
                    <p style='color: #C0C0C0; font-size: 0.9rem; line-height: 1.6;'>
                        Geomagnetically induced currents from solar storms can cause massive blackouts. 
                        Prediction allows proactive mitigation of operational risks.
                    </p>
                </div>
                """, unsafe_allow_html=True)
            ...
            with context_col3:
                ...
                <div class='info-card'>
                    ...
                    <p style='color: #C0C0C0; font-size: 0.9rem; line-height: 1.6;'>
                        ...
                        Forecasting enables contingency planning for critical services.
                    </p>
                </div>
                """, unsafe_allow_html=True)
        ...
        with st.container():
            ...
            st.markdown("""
            **HELIOS** is an advanced solar activity prediction system using deep learning 
            ...
            **Technical Specifications**:
            - Architecture: SolarNet V2 PRO (4 convolutional layers)
